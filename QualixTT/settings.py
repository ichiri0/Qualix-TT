"""
Django settings for QualixTT project.
...
SECRET_KEY = 'django-insecure-fi7mupr2s_hm$)11sqr6t8fjr-aea5jtp8*^+16$#kr)ah175a'
...
WSGI_APPLICATION = 'QualixTT.wsgi.application'
